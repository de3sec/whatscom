                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="card sticky-top" style="top:30px">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                @if(Auth::user()->type == 'Owner')
                                    <a href="#store_settings" class="list-group-item list-group-item-action border-0">{{__('Store Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                    <a href="#theme_settings" class="list-group-item list-group-item-action border-0">{{__('Theme Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                     <a href="#brand_settings" class="list-group-item list-group-item-action border-0">{{__('Brand Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                     <a href="#store_payment-settings" class="list-group-item list-group-item-action border-0">{{__('Payment Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                     <a href="#store_email_settings" class="list-group-item list-group-item-action border-0">{{__('Email Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                    <a href="#whatsapp_custom_massage" class="list-group-item list-group-item-action border-0">{{__('WhatsApp Mail Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                    <a href="#twilio_settings" class="list-group-item list-group-item-action border-0">{{__('Twilio Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                ...
                                @if(Auth::user()->type == 'super admin')
                                    ...
                                    <a href="#email_settings" class="list-group-item list-group-item-action border-0">{{__('Email Settings')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                    <a href="#recaptcha_settings" class="list-group-item list-group-item-action border-0">{{__('ReCaptcha Settings')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                    <a href="#storage_settings" class="list-group-item list-group-item-action border-0">{{ __('Storage Settings') }}
                    ...
                    <div class="col-xl-9">
                       @if(Auth::user()->type == 'Owner')
                                                ...
                                                <div class=" setting-card">
                                                    <div class="row mt-2">
                                                                    ...
                                                                    <div class=" setting-card">
                                                                        <div class="logo-content mt-4">
                                                                            ...
                                                                            <a href="{{$s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png')}}" target="_blank">
                                                                                <img id="StorelogoOwner" alt="your image" src="{{$s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png')}}" width="150px" class="big-logo">
                                                                            </a>
                                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6 col-lg-6">
                                                            ...
                                                            {!! Form::textarea('metakeyword', $store_settings->meta_data, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Meta Keyword')]) !!}
                                                            @error('meta_keywords')
                                                                <span class="invalid-about" role="alert">
                                                                    <strong class="text-danger">{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-group col-md-6 col-lg-6">
                                                            ...
                                                            {!! Form::textarea('metadesc', $store_settings->meta_description, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Meta Description')]) !!}
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                {{Form::label('footer_note',__('Footer'),array('class'=>'col-form-label')) }}
                                                                {{Form::text('footer_note',null,array('class'=>'form-control','placeholder'=>__('Footer')))}}
                                                                @error('footer_note')
                            ...
                            <div id="theme_settings" class="card">
                                <div class="card-header">
                                                        ...
                                                        <div class=" setting-card">
                                                            <div class="logo-content mt-4">
                                                                ...
                                                                <a href="{{$logo.(isset($logo_light) && !empty($logo_light)?$logo_light:'logo-light.png')}}" target="_blank">
                                                                    <img id="storeLighlogo" alt="your image" src="{{$logo.(isset($logo_light) && !empty($logo_light)?$logo_light:'logo-light.png')}}" width="150px" class="big-logo img_setting">
                                                                </a>
                                                            </div>
                                                            <div class="choose-files mt-5">
                                                                <label for="company_light_logo">
                                                                    ...
                                                                    <input type="file" class="form-control file" name="company_light_logo" id="company_light_logo"
                                                                        data-filename="company_light_logo_update" onchange="document.getElementById('storeLighlogo').src = window.URL.createObjectURL(this.files[0])">
                                                                </label>
                                                            </div>
                                                            @error('light_logo')
                                                                <div class="row">
                            ...
                            <div id="store_payment-settings" class="card">
                            ...
                            <div id="store_email_settings" class="card">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <a href="#" data-url="{{route('test.mail' )}}" data-ajax-popup="true" data-title="{{__('Send Test Mail')}}" class="send_email btn btn-xs btn-primary">
                                                {{__('Send Test Mail')}}
                                            </a>
                                        </div>
                            ...
                            <div class="active card" id="brand_settings">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            {{Form::label('gdpr_cookie',__('GDPR Notification'),array('class' => 'col-form-label')) }}
                                        ...
                                        <div class="form-group col-md-3">
                                            {{Form::label('display_landing_page_',__('Enable Landing Page'),array('class' => 'col-form-label')) }}
                                            <div class="col-12 mt-2">
                                                <div class="custom-control custom-switch">
