                        ...
                        <div class="card">
                            <div class="card-body">
                                @if (!empty($products->is_cover))
                                    <img alt="Image placeholder" src="{{ $logo . $products->is_cover }}"
                                        class="img-fluid rounded prd_img_lg">

                                    {{-- <img alt="Image placeholder" alt="your image" src="{{$logo.(isset($product->is_cover) && !empty($product->is_cover)?$product->is_cover:'is_cover_image.png')}}" class="img-fluid rounded prd_img_lg"> --}}
                                @else
                                    <img alt="Image placeholder" src="{{ $logo . $products->is_cover }}"
                                        class="img-fluid rounded prd_img_lg">
                                @endif
                                            ...
                                            <div class="p-3 border rounded">
                                                @if (!empty($products_image[$key]->product_images))
                                                    <img alt="Image placeholder"
                                                        src="{{ $p_logo . $products_image[$key]->product_images }}"
                                                        class="img-fluid prd_img_sm">
                                                    {{-- <img alt="Image placeholder" src="{{$p_logo.(isset($file->product_images) && !empty($file->product_images)?$file->product_images:'is_cover_image.png')}}" class="img-fluid prd_img_sm"> --}}
                                                @else
                                                    <img alt="Image placeholder"
                                                        src="{{ $p_logo . $products_image[$key]->product_images }}"
                                                        class="img-fluid prd_img_sm">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if (!empty($products->custom_field_4) && !empty($products->custom_value_4))
                                    <div class="cart-buttons">
                                        <div class="mb-0 t-black14"><span
                                                class="t-gray">{{ $products->custom_field_4 }} : </span>
                                                ...
                                                <div class="mt-1">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item">
                                                            <span
                                                                class="badge badge-pill badge-soft-info">{{ __('ID: #') }}{{ $products->SKU }}</span>
                                                        </li>
                                                        <li class="list-inline-item">
