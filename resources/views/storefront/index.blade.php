...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="coupon-box">
                                        ...
                                        <div class="form-group mb-0 product-detail apply-stripe-btn-coupon">
                                            <a href="#"
                                                    ...
                                                    <div class="checkout-items">
                                                        ...
                                                        <div class="customer-name">
                                                            <div style="overflow-wrap: break-word;">
                                                                <h6 class="title mt-5" style="width: 80px; height: 80px; overflow: hidden; text-overflow: ellipsis;">
                                                                    <a style="text-overflow: ellipsis; overflow: hidden;" href="#">{{ $product['product_name'] }}</a>
                                                                </h6>
                                                            </div>
                                                            <div>
                                                                <span class="detail-qty pr-1">
    ...
    <script type="text/javascript">
        @if (!empty($store_payments['is_stripe_enabled']) &&
