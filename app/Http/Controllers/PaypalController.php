...
// dd($paypalToken);
                    ...
                    // try
                    // {
                    //     $provider->create($this->paymentconfig);
                    // }
                    ...
                    return redirect()->back()->with('error', __('Unknowdssffn error occurred'));
                // }
                // catch(\Exception $e)
                // {
    ...
    public function GetPaymentStatus(Request $request, $slug)
    {
        ...
        if($product)
        {
            ...
            // {
                ...
                // $status  = ucwords(str_replace('_', ' ', $response['status']));
